...
class TestCompareStrategies(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Tight constraints
        self.tight_cons1 = {1: np.array([0, 1, 0, 1]),
                              2: np.array([0, 1, 1, 0])}
        self.tight_cons1cp = {1: np.array([0, 1, 0, 1]),
                                2: np.array([0, 1, 1, 0])}
        self.tight_cons1w = {1: np.array([0, 1, 0, 1]),
                               2: np.array([-1, 1, 1, 0])}
        self.tight_cons2 = {6: np.array([0, 1, 0, 1]),
                              19: np.array([1, 1, 0, 0, 0])}
        self.tight_cons3 = {6: np.array([0, 1, 0, 1]),
                              8: np.array([1, 1]),
                              19: np.array([1, 1, 0, 0, 0])}
